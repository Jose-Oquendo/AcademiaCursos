...
<div class="row mb-5"> {{--El row debe sacarse del ciclo para poder q se vea en columnas --}}
    ...
    {{--Con lo siguiente hacemos el card--}}
        <div class="col-md-4 col-sm-6"> {{--Aqui ponemos el tamaño q sacamos de botstrapt--}}
            <div class="card text-center" style="width: 18rem; margin-top:20px">
                <img style="height: 150px;" src="{{Storage::url($alias->imagen)}}" class="card-img-top mx-auto d-block" alt="imagen del curso"> {{-- usamos el botstrapt para organizar la imagen--}}
